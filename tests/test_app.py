...
VFILE_FINAL_PATHS = [
    ...
    "anime_dir/Akudama Drive/[Erai-raws] Akudama Drive - 11 [720p].mkv",

    # "anime_dir/Haikyuu/Season 5/"
    # "[Erai-raws] Haikyuu!! To the Top 2nd Season - 01 "
    # "[720p][Multiple Subtitle].mkv",

    "anime_dir/Jujutsu Kaisen/"
    "[Erai-raws] Jujutsu Kaisen - 12 [720p][Multiple Subtitle].mkv",

    "anime_dir/Kamisama ni Natta Hi/"
    "[Erai-raws] Kamisama ni Natta Hi - 10 [720p].mkv",

    "anime_dir/Maoujou de Oyasumi/"
    "[Erai-raws] Maoujou de Oyasumi - 11 [720p].mkv",

    "anime_dir/Munou na Nana/[Erai-raws] Munou na Nana - 11 [720p].mkv",

    "anime_dir/Shingeki no Kyojin (Attack on Titan)/Season 4/"
    "[Erai-raws] Shingeki no Kyojin - The Final Season - 02 "
    "[720p][Multiple Subtitle].mkv",
]
